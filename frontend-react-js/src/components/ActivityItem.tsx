...
export default function ActivityItem(props: { activity: { replies: any[]; uuid: any; replies_count: any; reposts_count: any; likes_count: number; }; setReplyActivity: any; setPopped: any; }) {
